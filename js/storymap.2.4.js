// Modified by Aradia Farmer, farmera@oregonstate.edu, from version provided by Bo Zhao
...
(function ($) {
    ...
    $.fn.storymap = function (options) {
        ...
        var defaults = {
            ...
            createMap: function () {
                var map = L.map($('.storymap-map')[0], {zoomControl: false}).setView([44.053972, -123.712515], 10.5);
